  ...
  return (
    <div className="user-management-page min-h-full bg-slate-100/80 py-5 sm:py-10 dark:bg-[#0b1120]">
      <div className="mx-auto w-full max-w-7xl px-3 sm:px-6">
        ...
        <p className="mt-1 text-xs leading-5 text-slate-500 sm:mt-2 sm:whitespace-nowrap sm:text-base">Manage your team members and control their access to mini apps</p>
