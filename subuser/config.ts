...
export const COMPANY_MEMBER_ROLES: Array<{ value: CompanyRole; label: string }> = [
  ...
  // The 'reception' role is labeled as 'Admin' for clarity in the UI.
  // if anything needs to be changed for admin role, the value should still be 'reception' to match the backend.
