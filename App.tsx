...
import type { ProfileCompletionStatus } from './sharedPet/CatMascot';
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[11px] font-semibold text-slate-400 truncate">
                            {creditBalance !== null ? `${creditBalance.toLocaleString('en-US')} credits` : 'Loading...'}
                          </p>
                        </div>
                        <i className="fa-solid fa-chevron-right text-[10px] text-slate-300 group-hover:text-slate-400 transition-colors"></i>
                      </button>
                        ...
                        >
                          ...
                          <span className="flex-1 min-w-0">
                            <span className="block text-sm font-bold text-slate-900 leading-tight">
                              {accountType === 'admin' ? 'Support Ticketing' : 'Support Ticketing'}
                            </span>
